...
HD_PWD='C:/Maestria/carrier_recovery/carrier_recovery.runs/ram_atan_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_atan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_atan.tcl
