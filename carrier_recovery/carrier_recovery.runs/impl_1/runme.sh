...
HD_PWD='C:/Maestria/carrier_recovery/carrier_recovery.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log carrier_recovery.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source carrier_recovery.tcl -notrace
