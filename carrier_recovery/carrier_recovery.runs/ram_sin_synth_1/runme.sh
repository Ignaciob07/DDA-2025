...
HD_PWD='C:/Maestria/carrier_recovery/carrier_recovery.runs/ram_sin_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_sin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_sin.tcl
