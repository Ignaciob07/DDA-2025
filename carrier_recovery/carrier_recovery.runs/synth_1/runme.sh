...
HD_PWD='C:/Maestria/carrier_recovery/carrier_recovery.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carrier_recovery.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carrier_recovery.tcl
