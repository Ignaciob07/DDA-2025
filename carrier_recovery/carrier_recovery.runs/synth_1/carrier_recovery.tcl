...
namespace eval ::optrace {
  variable script "C:/Maestria/carrier_recovery/carrier_recovery.runs/synth_1/carrier_recovery.tcl"
...
synth_design -top carrier_recovery -part xc7a35ticsg324-1L
...
write_checkpoint -force -noxdef carrier_recovery.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file carrier_recovery_utilization_synth.rpt -pb carrier_recovery_utilization_synth.pb"
