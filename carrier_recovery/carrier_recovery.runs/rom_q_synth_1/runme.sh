...
HD_PWD='C:/Maestria/carrier_recovery/carrier_recovery.runs/rom_q_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_q.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_q.tcl
