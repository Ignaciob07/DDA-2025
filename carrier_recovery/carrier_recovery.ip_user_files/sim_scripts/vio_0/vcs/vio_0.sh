...
#
# Script generated by Vivado on Thu May 29 11:43:20 -0300 2025
...
# script info
echo -e "vio_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../carrier_recovery.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../carrier_recovery.gen/sources_1/ip/vio_0/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../carrier_recovery.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../carrier_recovery.gen/sources_1/ip/vio_0/hdl" \
