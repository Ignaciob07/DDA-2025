...
#                script (type 'ram_atan.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_atan xil_defaultlib.glbl -o ram_atan_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_atan_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ram_atan_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_atan_simv.daidir vcs_lib c.obj)
