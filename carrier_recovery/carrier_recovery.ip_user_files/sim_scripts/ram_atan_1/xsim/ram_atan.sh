...
#
# Script generated by Vivado on Thu May 29 13:39:10 -0300 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ram_atan.sh
...
#
# Usage        : ram_atan.sh
#                ram_atan.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_atan.sh [-reset_run]
#                ram_atan.sh [-reset_log]
#                ram_atan.sh [-help]
#
...
# script info
echo -e "ram_atan.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_atan.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_atan xil_defaultlib.ram_atan xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_atan -key {Behavioral:sim_1:Functional:ram_atan} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram_atan.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_atan.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_atan.sh [-help]\n\
Usage: ram_atan.sh [-step]\n\
Usage: ram_atan.sh [-lib_map_path]\n\
Usage: ram_atan.sh [-reset_run]\n\
Usage: ram_atan.sh [-reset_log]\n\
Usage: ram_atan.sh [-keep_index]\n\
Usage: ram_atan.sh [-noclean_files]\n\n\
