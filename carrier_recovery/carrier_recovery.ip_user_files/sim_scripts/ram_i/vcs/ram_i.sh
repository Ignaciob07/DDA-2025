...
#                script (type 'ram_i.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_i xil_defaultlib.glbl -o ram_i_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_i_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ram_i_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_i_simv.daidir vcs_lib c.obj)
