...
#
# Script generated by Vivado on Wed May 21 10:51:52 -0300 2025
...
#
# Usage        : ram_sin.sh
#                ram_sin.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_sin.sh [-reset_run]
#                ram_sin.sh [-reset_log]
#                ram_sin.sh [-help]
#
...
# script info
echo -e "ram_sin.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_sin.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_sin xil_defaultlib.ram_sin xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_sin -key {Behavioral:sim_1:Functional:ram_sin} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram_sin.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_sin.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_sin.sh [-help]\n\
Usage: ram_sin.sh [-step]\n\
Usage: ram_sin.sh [-lib_map_path]\n\
Usage: ram_sin.sh [-reset_run]\n\
Usage: ram_sin.sh [-reset_log]\n\
Usage: ram_sin.sh [-keep_index]\n\
Usage: ram_sin.sh [-noclean_files]\n\n\
