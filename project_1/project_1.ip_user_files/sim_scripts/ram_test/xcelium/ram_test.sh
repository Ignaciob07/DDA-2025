...
#
# Script generated by Vivado on Tue May 20 08:35:01 -0300 2025
...
#
# Usage        : ram_test.sh
#                ram_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_test.sh [-reset_run]
#                ram_test.sh [-reset_log]
#                ram_test.sh [-help]
#
...
#                script (type 'ram_test.sh -help' for more information).
#
...
# script info
echo -e "ram_test.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ram_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ram_test -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ram_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ram_test.sh [-step]\n\
Usage: ram_test.sh [-lib_map_path]\n\
Usage: ram_test.sh [-reset_run]\n\
Usage: ram_test.sh [-reset_log]\n\
Usage: ram_test.sh [-keep_index]\n\
