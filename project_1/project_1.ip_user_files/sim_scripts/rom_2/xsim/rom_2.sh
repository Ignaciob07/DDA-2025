...
#
# Script generated by Vivado on Tue May 20 08:36:33 -0300 2025
...
#
# Usage        : rom_2.sh
#                rom_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom_2.sh [-reset_run]
#                rom_2.sh [-reset_log]
#                rom_2.sh [-help]
#
...
# script info
echo -e "rom_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom_2 xil_defaultlib.rom_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rom_2 -key {Behavioral:sim_1:Functional:rom_2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rom_2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rom_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rom_2.sh [-help]\n\
Usage: rom_2.sh [-step]\n\
Usage: rom_2.sh [-lib_map_path]\n\
Usage: rom_2.sh [-reset_run]\n\
Usage: rom_2.sh [-reset_log]\n\
Usage: rom_2.sh [-keep_index]\n\
Usage: rom_2.sh [-noclean_files]\n\n\
