...
#                script (type 'rom_2.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rom_2 xil_defaultlib.glbl -o rom_2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rom_2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rom_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rom_2_simv.daidir vcs_lib c.obj)
