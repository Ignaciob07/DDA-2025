...
HD_PWD='C:/Maestria/DDA-2025/enviroment_test/enviroment_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_test_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_test_module.tcl
