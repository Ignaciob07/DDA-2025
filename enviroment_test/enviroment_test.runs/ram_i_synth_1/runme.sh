...
HD_PWD='C:/Maestria/DDA-2025/enviroment_test/enviroment_test.runs/ram_i_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_i.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_i.tcl
