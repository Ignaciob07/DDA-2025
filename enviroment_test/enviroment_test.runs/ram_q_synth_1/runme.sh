...
HD_PWD='C:/Maestria/DDA-2025/enviroment_test/enviroment_test.runs/ram_q_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_q.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_q.tcl
