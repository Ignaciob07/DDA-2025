...
HD_PWD='C:/Maestria/DDA-2025/enviroment_test/enviroment_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_test_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_test_module.tcl -notrace
