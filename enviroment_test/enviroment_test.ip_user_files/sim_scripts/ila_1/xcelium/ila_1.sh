...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../enviroment_test.gen/sources_1/ip/ila_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../enviroment_test.gen/sources_1/ip/ila_1/hdl/verilog" \
