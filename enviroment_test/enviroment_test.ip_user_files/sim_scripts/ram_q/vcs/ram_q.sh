...
#                script (type 'ram_q.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_q xil_defaultlib.glbl -o ram_q_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_q_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ram_q_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_q_simv.daidir vcs_lib c.obj)
